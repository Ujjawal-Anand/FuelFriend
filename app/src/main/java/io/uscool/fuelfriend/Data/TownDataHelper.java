...
public class TownDataHelper {
    ...
    private static List<TownWrapper> sColorWrappers = new ArrayList<>();

    private static List<TownSuggestion> sColorSuggestions =
    ...
    public static List<TownSuggestion> getHistory(Context context, int count) {
        ...
        TownSuggestion colorSuggestion;
    ...
    public static void resetSuggestionsHistory() {
        for (TownSuggestion colorSuggestion : sColorSuggestions) {
        ...
        new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (!(constraint == null || constraint.length() == 0)) {
                    ...
                    for (TownSuggestion suggestion : sColorSuggestions) {
        ...
        new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (!(constraint == null || constraint.length() == 0)) {
                    ...
                    for (TownWrapper color : sColorWrappers) {
                        if (color.getTownName()
    ...
    private static List<TownWrapper> deserializeColors(String jsonString) {
